...
class CatalogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Catalog
        fields = [
            'id', 'code', 'sku', 'name', 'description', 'obs', 'menu', 'menu_name',
            'group', 'group_name', 'category', 'category_name', 'type', 'type_name',
            'restriction', 'chef_recommendation', 'usage_instructions', 'price',
            'min_quantity_purchase', 'rations_quantity', 'cover_image',
            'secondary_image', 'complementary_image', 'image_gallery',
            'configuration', 'is_visible', 'is_deleted', 'is_confirmed',
...
class ItemConfigurationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'code', 'configuration', 'description', 'package', 'package_description',
...
class ItemConfigurationDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'code', 'detail', 'type', 'type_name', 'configuration', 'configuration_name',
            'id_item', 'is_deleted', 'is_confirmed', 'created_at', 'updated_at',
            'confirmed_at', 'deleted_at', 'created_by', 'confirmed_by', 'updated_by', 'deleted_by'
        ]
